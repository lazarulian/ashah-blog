...
const PostCard = ({ post }) => {
  ...
  return (
    <div className='bg-white shadow-lg rounded-xl p-0  lg:p-8 pb-12 mb-8'>
      ...
      <h1 className='transition duration-1000 text-center mb-8 mr-6 ml-6 cursor-pointer 
      ...
      <div className='block lg:flex text-center items-center justify-center mb-8 w-full'>
        ...
        <div className='font-medium text-lg text-gray-700 mb-4'>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 inline ml-2 mr-2 text-pink-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
